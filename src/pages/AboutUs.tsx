              ...
              <div className={`animate-on-scroll-left ${missionVisible ? "visible" : ""}`}>
                ...
                <div className="flex flex-wrap gap-3">
                  {pillars.map((pillar, index) => (
                    <div
                      key={index}
                      className={`inline-flex items-center gap-2 px-4 py-2 rounded-full bg-liberation-cream/10 border border-liberation-cream/20 animate-on-scroll-scale stagger-${index + 1} ${missionVisible ? "visible" : ""}`}
                    >
