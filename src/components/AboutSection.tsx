const AboutSection = () => {
  ...
  return (
    <section id="about" className="py-24 bg-liberation-dark">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              {pillars.map((pillar, index) => (
                <span
                  key={index}
                  className={`inline-flex items-center gap-2 px-4 py-2 rounded-full bg-liberation-cream/10 border border-liberation-cream/20`}
                >
